...
// Helper to query all storefront components from raw database tables
async function queryCurrentDatabaseState() {
  const [categories, products, banners, webContents, settings] =
    await Promise.all([
...
export async function discardDraft() {
  ...
  // Re-sync categories, products, banners, content, settings from snapshot if needed
  invalidateStorefrontCache();
